...
TODO: не уверен в решенеии, тут скорее требуется показать от контроллера каждого компонента обработку сообщений. Напрашивается скорее диаграмма последовательностей, от которой уже формировать классы.
